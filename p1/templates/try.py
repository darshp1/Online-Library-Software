...
from p1.models import User,Books
...
def Search_Book():
	...
	if request.method == "POST":
		...
		colours=[{'name':bname}, {'name':bname+"1"}, {'name':'blue'}]
		if bname:
...
@app.route('/Searchd_Book', methods=['POST'])
def Searching_Book():
	book = request.form['searchbooks']  
	'''  getdata in py var '''

	print(book)
	return render_template('Searchedbook.html',book=book)